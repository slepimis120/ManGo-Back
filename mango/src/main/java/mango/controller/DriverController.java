...
public class DriverController {
	...
	public ResponseEntity insertWorkHour(@PathVariable Integer id_driver, @RequestBody @NotNull JSONObject start) {
	...
	public ResponseEntity updateWorkHour(@PathVariable Integer workingHourId, @RequestBody @NotNull JSONObject end) {
	...
	public ResponseEntity postVehicle(@PathVariable Integer id, @RequestBody VehicleDTO vehicle){
